...
unless rand_key == 0 || params["force"]
  ...
  begin
    user_tweets = Twitter.home_timeline(:count => 200, :trim_user => true, :include_rts => true, :include_entities => true)
    ...
    17.times do
      user_tweets = Twitter.home_timeline(:count => 200, :trim_user => true, :max_id => max_id - 1, :include_rts => true, :include_entities => true)
